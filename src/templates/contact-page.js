...
export const ContactPageTemplate = ({
  ...
  <div className="contact-page">
    ...
    <GatsbyImage
      ...
      alt="Ferguson Box building entrance"
      className="contact-page__photo"
    ></GatsbyImage>
    <div className="contact-page__info">
      <p>
        PHONE: <a href={'tel:' + phoneNum1.replace(/-|\./g, '')}>{phoneNum1}</a>{' '}
        <span>■</span>{' '}
        <a href={'tel:' + phoneNum2.replace(/-|\./g, '')}>{phoneNum2}</a>{' '}
      </p>
      <p>FAX: {faxNum}</p>
      <p>
      ...
      <p>
        OFFICE HOURS: {officeDays} <span>■</span> {officeHours}
      </p>
    </div>
    <div className="contact-page__address">
      <p>
        CORPORATE/SALES OFFICES <span>■</span> MANUFACTURING PLANT
      </p>
      <p>{addressLine1}</p>
      <p>{addressLine2}</p>
      <p>{directions}</p>
    ...
    <iframe
      ...
      title="googleMaps"
      src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d2880.0126953917106!2d-80.98749413705049!3d35.13866060972075!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x88569a00ec909029%3A0x401e45301e7065ae!2sFerguson+Box!5e0!3m2!1sen!2sus!4v1465611443781"
      width="600"
    ></iframe>
  </div>
)
